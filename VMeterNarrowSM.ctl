VERSION 5.00
Begin VB.UserControl VMeterNarrowSM 
   BackColor       =   &H00000000&
   ClientHeight    =   1935
   ClientLeft      =   0
   ClientTop       =   0
   ...
   ScaleHeight     =   1935
   ScaleWidth      =   375
   ToolboxBitmap   =   "VMeterNarrowSM.ctx":0000
   ...
   End
End
Attribute VB_Name = "VMeterNarrowSM"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = True
Attribute VB_PredeclaredId = False
Attribute VB_Exposed = False
'*******************************************************************************
' MODULE:       VMeterNarrowSM
' FILENAME:     C:\My Projects\Visual Basic\Custom Controls\Vert Meter\VMeterNarrowSM.ctl
