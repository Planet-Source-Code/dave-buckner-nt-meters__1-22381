VERSION 5.00
Begin VB.UserControl VDualMeterSM 
   BackColor       =   &H00000000&
   ClientHeight    =   1935
   ClientLeft      =   0
   ClientTop       =   0
   ...
   ScaleHeight     =   1935
   ScaleWidth      =   720
   ToolboxBitmap   =   "VDualMeterSmall.ctx":0000
   ...
   End
End
Attribute VB_Name = "VDualMeterSM"
...
'*******************************************************************************
' MODULE:       VDualMeterSM
' FILENAME:     C:\My Projects\Visual Basic\Custom Controls\Vert Meter\VDualMeterSmall.ctl
