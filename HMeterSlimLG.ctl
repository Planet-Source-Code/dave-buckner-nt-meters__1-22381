VERSION 5.00
Begin VB.UserControl HMeterSlimLG 
   BackColor       =   &H00000000&
   ClientHeight    =   405
   ClientLeft      =   0
   ClientTop       =   0
   ...
   ScaleHeight     =   405
   ScaleWidth      =   5265
   ToolboxBitmap   =   "HMeterSlimLG.ctx":0000
   ...
   End
End
Attribute VB_Name = "HMeterSlimLG"
...
'*******************************************************************************
' MODULE:       HMeterSlimLG
' FILENAME:     C:\My Projects\Visual Basic\Custom Controls\Vert Meter\HMeterSlimLG.ctl
