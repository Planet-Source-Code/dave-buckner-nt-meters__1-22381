VERSION 5.00
Begin VB.UserControl HMeterTallSM 
   BackColor       =   &H00000000&
   ClientHeight    =   495
   ClientLeft      =   0
   ClientTop       =   0
   ...
   ScaleHeight     =   495
   ScaleWidth      =   3195
   ToolboxBitmap   =   "HMeterTallSM.ctx":0000
   ...
   End
End
Attribute VB_Name = "HMeterTallSM"
...
'*******************************************************************************
' MODULE:       HMeterTallSM
' FILENAME:     C:\My Projects\Visual Basic\Custom Controls\Vert Meter\HMeterTallSM.ctl
