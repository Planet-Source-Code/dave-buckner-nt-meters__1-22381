VERSION 5.00
Begin VB.UserControl VMeterWideLG 
   BackColor       =   &H00000000&
   ClientHeight    =   3360
   ClientLeft      =   0
   ClientTop       =   0
   ...
   ScaleHeight     =   3360
   ScaleWidth      =   555
   ToolboxBitmap   =   "VMeterWideLG.ctx":0000
   ...
   End
End
Attribute VB_Name = "VMeterWideLG"
...
'*******************************************************************************
' MODULE:       VMeterWideLG
' FILENAME:     C:\My Projects\Visual Basic\Custom Controls\Vert Meter\VMeterWideLG.ctl
