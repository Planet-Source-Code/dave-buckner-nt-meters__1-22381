VERSION 5.00
Begin VB.UserControl HMeterTallLG 
   BackColor       =   &H00000000&
   ClientHeight    =   480
   ClientLeft      =   0
   ClientTop       =   0
   ...
   ScaleHeight     =   480
   ScaleWidth      =   5265
   ToolboxBitmap   =   "HMeterTallLG.ctx":0000
   ...
   End
End
Attribute VB_Name = "HMeterTallLG"
...
'*******************************************************************************
' MODULE:       HMeterTallLG
' FILENAME:     C:\My Projects\Visual Basic\Custom Controls\Vert Meter\HMeterTallLG.ctl
