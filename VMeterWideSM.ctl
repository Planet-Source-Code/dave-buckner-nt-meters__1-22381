VERSION 5.00
Begin VB.UserControl VMeterWideSM 
   BackColor       =   &H00000000&
   ClientHeight    =   1935
   ClientLeft      =   0
   ClientTop       =   0
   ...
   ScaleHeight     =   1935
   ScaleWidth      =   555
   ToolboxBitmap   =   "VMeterWideSM.ctx":0000
   ...
   End
End
Attribute VB_Name = "VMeterWideSM"
...
'*******************************************************************************
' MODULE:       VMeterWideSM
' FILENAME:     C:\My Projects\Visual Basic\Custom Controls\Vert Meter\VMeterWideSM.ctl
